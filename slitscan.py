...
def make_image(files):
    ...
    if out_width > MAX_DIMENSION:
        sys.exit(
            "Output image is too wide: " + str(out_width) + " (Max: " +
            str(MAX_DIMENSION) +
            "). Tip: avoid --greedy or use a smaller --thickness.")
    if out_height > MAX_DIMENSION:
        sys.exit(
            "Output image is too high: " + str(out_height) + " (Max: " +
            str(MAX_DIMENSION) +
            "). Tip: avoid --greedy or use a smaller --thickness.")
